                    ...
                    <div class="box-body pb-0">
                        <div class="flex">
                            <div class="flex space-x-3 rtl:space-x-reverse">
                                ...
                                <h6
                                    class="text-lg font-semibold text-gray-800 mb-2 dark:text-white my-auto">
                                    Total Revenue</h6>
                            </div>
                            <span
            ...
            <div class="col-span-12 lg:col-span-6 xxl:col-span-3">
                <div class="box">
                    ...
                    <div class="box-body pb-0 px-0">
                        <div
                            class="sales-value relative border-b border-gray-200 dark:border-white/10 pb-6">
                        ...
                        <div class="grid grid-cols-2">
                            <div class="p-5 ltr:border-r rtl:border-l border-gray-200 dark:border-white/10">
                                <div
                                    class="text-sm text-gray-500 dark:text-white/80 text-center font-medium">
                                    Sale Items
                                </div>
                            ...
                            <div class="p-5">
                                ...
                                <div class="text-center">
                                    <p class="text-gray-800 dark:text-white text-2xl font-semibold">$11,197
                                    </p>
                        ...
                        <ul class="flex flex-col">
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/2.jpg" alt="Image Description"/>
                            ...
                            <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/3.jpg" alt="Image Description"/>
                                        <div class="flex w-full">
                                            <div class="block my-auto">
                                                <p
                                                    class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                            ...
                            <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/4.jpg" alt="Image Description"/>
                                        <div class="flex w-full">
                                            <div class="block my-auto">
                                                <p
                                                    class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                            ...
                            <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/5.jpg" alt="Image Description"/>
                                        <div class="flex w-full">
                                            <div class="block my-auto">
                                                <p
                                                    class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                            ...
                            <li class="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/6.jpg" alt="Image Description"/>
                                        <div class="flex w-full">
                                            <div class="block my-auto">
                                                <p
                                                    class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                            ...
                            <li class="px-0 pt-3 pb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                        <img class="avatar avatar-sm rounded-sm"
                                            src="build/assets/img/users/10.jpg" alt="Image Description"/>
                                        <div class="flex w-full">
                                            <div class="block my-auto">
                                                <p
                                                    class="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
                                    ...
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/1.jpg" alt="image"/>
                                        </div>
                                        ...
                                        <div class="block text-end">
                                            ...
                                            <p
                                                class="text-xs text-gray-400 dark:text-white/80 !font-normal">
                            ...
                            <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/2.jpg" alt="null"/>
                                        </div>
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                            ...
                            <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/3.jpg" alt="image"/>
                                        </div>
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                            ...
                            <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/4.jpg" alt="image"/>
                                        </div>
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                        ...
                                        <div class="block text-end">
                                            <span
                                                class="text-sm text-success font-semibold">$1,699.00</span>
                                            <p
                                                class="text-xs text-gray-400 dark:text-white/80 !font-normal">
                                                <i class="ti ti-clock-hour-2 ltr:mr-1 rtl:mr-1"></i>01 Apr,
                                                2023
                            ...
                            <li class="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/6.jpg" alt="image"/>
                                        </div>
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                            ...
                            <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white">
                                <a href="javascript:void(0);" class="w-full">
                                    <div class="flex items-center">
                                        <div class="leading-none">
                                            <img class="avatar avatar-sm rounded-full"
                                                src="build/assets/img/ecommerce/jpg/5.jpg" alt="image"/>
                                        </div>
                                        <div class="flex-auto ltr:ml-2 rtl:mr-2">
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            ...
                                            <img src="build/assets/img/ecommerce/products/13.png"
                                    ...
                                    <tr>
                                        <td
                                            class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                            <img src="build/assets/img/ecommerce/products/14.png"
                                                class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                    ...
                                    <tr>
                                        <td
                                            class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                            <img src="build/assets/img/ecommerce/products/15.png"
                                                class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                    ...
                                    <tr>
                                        <td
                                            class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                            <img src="build/assets/img/ecommerce/products/16.png"
                                                class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                    ...
                                    <tr>
                                        <td
                                            class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                            <img src="build/assets/img/ecommerce/products/17.png"
                                                class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                    ...
                                    <tr>
                                        <td
                                            class="leading-none !text-gray-800 dark:!text-white !p-[0.65rem] min-w-[180px] truncate">
                                            <img src="build/assets/img/ecommerce/products/18.png"
                                                class="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-black/20 ltr:mr-2 rtl:ml-2"
                                ...
                                <tbody class="">
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/2.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/3.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                                        class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                    src="build/assets/img/ecommerce/products/3.png"
                                                    alt="Image Description"/>
                                                <div class="block w-full my-auto">
                                                    <span
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/4.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                                        class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                    src="build/assets/img/ecommerce/products/4.png"
                                                    alt="Image Description"/>
                                                <div class="block w-full my-auto">
                                                    <span
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/5.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                                        class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                    src="build/assets/img/ecommerce/products/5.png"
                                                    alt="Image Description"/>
                                                <div class="block w-full my-auto">
                                                    <span
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/9.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                                        class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse w-full">
                                                <img class="avatar rounded-sm bg-gray-100 dark:bg-black/20 p-2"
                                                    src="build/assets/img/ecommerce/products/6.png"
                                                    alt="Image Description"/>
                                                <div class="block w-full my-auto">
                                                    <span
                                        ...
                                        <td>
                                            <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                <img class="avatar avatar-sm rounded-sm"
                                                    src="build/assets/img/users/10.jpg"
                                                    alt="Image Description"/>
                                                <div class="block my-auto">
                                                    <p
                                                        class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
